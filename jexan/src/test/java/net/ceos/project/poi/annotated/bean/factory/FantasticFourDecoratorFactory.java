...
public class FantasticFourDecoratorFactory {

	private static FantasticFourDecoratorFactory factory = new FantasticFourDecoratorFactory();
	...
	/**
	 * More info at {@link Duplicate}
	 */
	public static Duplicate instanceDuplicate() {
		return factory.new Duplicate();
	}
	...
	public class MrFantastic {
		...
		@XlsElement(title = "String value", position = 1, decorator = "myDecorator")
	...
	public class HumanTorch {
		...
		@XlsElement(title = "Date value", position = 1, decorator = "myDecorator")
	...
	public class InvisibleWoman {
		...
		@XlsElement(title = "Header value", position = 1, decorator = "myDecorator")
