...
@XlsConfiguration(nameFile = "ObjectFormulaHorizontal", extensionFile = ExtensionFileType.XLSX)
@XlsSheet(title = "Formula test case")
public class ObjectFormulaHorizontal {
	...
	public ObjectFormulaHorizontal() {
	}
