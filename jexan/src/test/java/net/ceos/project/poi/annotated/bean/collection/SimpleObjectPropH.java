...
@XlsConfiguration(nameFile = "collection_object_simple_h", extensionFile = ExtensionFileType.XLSX)
@XlsSheet(title = "List Simple object horizontal", startRow = 2, propagation = PropagationType.PROPAGATION_HORIZONTAL,cascadeLevel=CascadeType.CASCADE_FULL)
public class SimpleObjectPropH {
