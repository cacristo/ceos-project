...
@XlsSheet(title = "Automatic Position", propagation = PropagationType.PROPAGATION_HORIZONTAL)
@XlsConfiguration(nameFile = "AutomaticPositionTestFile", extensionFile = ExtensionFileType.XLSX)
public class AutomaticPositionObject {

	@XlsElement(title = "Date value", formatMask = "yyyy/MM/dd")
	private Date dateAttribute1;

	@XlsElement(title = "Integer value 2", decorator="extraNumeric")
	private Integer integerAttribute2;

	@XlsElement(title = "String value 1")
	private String stringAttribute1;

	@XlsElement(title = "Integer value 1")
	private Integer integerAttribute1;

	@XlsElement(title = "Integer value 3")
	private Integer integerAttribute3;

	@XlsElement(title = "Integer value 4")
	private Integer integerAttribute4;

	@XlsElement(title = "Integer value 5")
	private Integer integerAttribute5;

	@XlsElement(title = "Integer value 6", comment="Under 1000", commentRules="rulesCommentInteger")
	private Integer integerAttribute6;

	@XlsElement(title = "Integer value 7")
	private Integer integerAttribute7;

	@XlsElement(title = "Double value 1", formatMask = "0.00")
	private Double doubleAttribute1;

	@XlsElement(title = "Double value 2", formatMask = "0.0")
	private Double doubleAttribute2;

	@XlsElement(title = "Double value 3", transformMask = "0.00000", decorator="extraNumeric")
	private Double doubleAttribute3;

	@XlsElement(title = "Long value")
	private Long longAttribute;

	@XlsElement(title = "Boolean value 1")
	private Boolean booleanAttribute1;

	@XlsElement(title = "Boolean value 2")
	private Boolean booleanAttribute2;

	@XlsElement(title = "Boolean value 3")
	private Boolean booleanAttribute3;

	@XlsElement(title = "Boolean value 4")
	private Boolean booleanAttribute4;

	@XlsElement(title = "job")
	private Job job;

	@XlsElement(title = "Primitive int value")
	...
	@XlsElement(title = "Primitive double value")
	private double doublePrimitiveAttribute;

	@XlsElement(title = "Primitive long value")
	private long longPrimitiveAttribute;

	@XlsElement(title = "Primitive boolean value", transformMask="Y/N")
	private boolean booleanPrimitiveAttribute = false;

	@XlsElement(title = "address info")
	private AddressInfo addressInfo;

	@XlsElement(title = "Float value")
	private Float floatAttribute;

	@XlsElement(title = "Primitive float value")
	private float floatPrimitiveAttribute;

	@XlsElement(title = "some sum", isFormula = true)
	private Double sumVal;

	@XlsElement(title = "Unit family")
	private UnitFamily unitFamily;

	@XlsElement(title = "BigDecimal value")
	private BigDecimal bigDecimalAttribute;

	@XlsElement(title = "String value 2")
	private String stringAttribute2;

	@XlsElement(title = "String value 3")
	private String stringAttribute3;

	@XlsElement(title = "String value 4")
	private String stringAttribute4;

	@XlsElement(title = "String value 5")
	private String stringAttribute5;

	@XlsElement(title = "String value 6")
	private String stringAttribute6;

	@XlsElement(title = "String value 7")
	private String stringAttribute7;

	@XlsElement(title = "String value 8")
	private String stringAttribute8;

	@XlsElement(title = "String value 9")
	private String stringAttribute9;

	@XlsElement(title = "String value 10")
	private String stringAttribute10;

	@XlsElement(title = "String value 11")
	private String stringAttribute11;

	@XlsElement(title = "String value 12")
	private String stringAttribute12;

	@XlsElement(title = "Date value transform", transformMask = "yyyy-MM-dd")
	private Date dateAttribute2;

	@XlsElement(title = "Date value transform", formatMask = "yyyy-MM")
	private Date dateAttribute3;

	public AutomaticPositionObject() {
	}
