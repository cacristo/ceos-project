...
@XlsConfiguration(nameFile = "file_list_object_simple_vert")
@XlsSheet(title = "List Simple object vertical", startCell = 2, propagation = PropagationType.PROPAGATION_VERTICAL)
