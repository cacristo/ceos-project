 ...
 * <li>inject</li>
 * <li>validate</li><br>
 * data at the object {@link PerformanceObject}<br>
 * 
 * @version 1.0
 * @author Carlos CRISTO ABREU
 */
public class PerformanceObjectBuilder {
	 ...
	 */
	public static PerformanceObject buildPerformanceObject() {
		return buildPerformanceObject(2);
	}
	...
	/**
	 * Create a list of PerformanceObject for tests.
	 * 
	 * @return the {@link PerformanceObject}
	 */
	...
	/**
	 * Validate the PerformanceObject based on the object build with the method
	 * 'buildPerformanceObject'
	 * 
	 * @param toValidate
	 *            the object to validate
	 */
	public static void validatePerformanceObject(PerformanceObject toValidate) {
		PerformanceObject base = buildPerformanceObject();
