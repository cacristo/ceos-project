...
@XlsDecorators(values = { @XlsDecorator(decoratorName = CellStyleHandler.CELL_DECORATOR_UNIQUE, foregroundColor = HSSFColor.GREEN.index, fontSize = 9) })
...
public class UniqueDecoratorObject {
